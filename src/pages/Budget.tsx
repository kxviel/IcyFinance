								...
								.map((category) => {
									...
									return (
										...
										>
											...
											>
												<span
													className={`w-5 h-5 block border border-subtle shrink-0 bg-[repeating-linear-gradient(_90deg,_transparent_0px_3px,_var(--muted-foreground)_3px_4px_)] max-[680px]:hidden symbol-${doc.categories.indexOf(category) % 4}`}
												/>
												<span>
